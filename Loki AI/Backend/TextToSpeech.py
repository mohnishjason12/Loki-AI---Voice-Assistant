import pygame   #importing pygame library for handiling audio playback
import random   #importing random library for generating random choices
import asyncio  #for asynchronous operations
import edge_tts #for text-to-speech functionality
import os       #for file path handiling
